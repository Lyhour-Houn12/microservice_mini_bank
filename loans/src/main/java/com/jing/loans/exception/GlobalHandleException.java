...
public class GlobalHandleException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleCardAlreadyExistsException(LoanAlreadyExistsException loanAlreadyExistsException, HttpServletRequest request) {
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                request.getRequestURI(),
